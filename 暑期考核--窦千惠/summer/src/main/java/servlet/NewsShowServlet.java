...
@WebServlet(urlPatterns = "/NewsShowServlet")
public class NewsShowServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        //分页传值
        int StartRecord=(PageNo-1)*5;
        page Page=new page();
        Page.setPageNo(PageNo);
        Page.setPageSize(PageSize);
        Page.setStartRecord(StartRecord);
        List<news> pageNews1 =newsMapper.PageNews(Page); //调用FenYe方法传值
        ...
        switch (a) {
            case 1: {
                req.getRequestDispatcher(req.getContextPath() + "AllNews.jsp").forward(req, resp);
                break;
            }
            case 2: {
