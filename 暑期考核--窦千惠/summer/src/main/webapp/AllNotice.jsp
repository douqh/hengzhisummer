                ...
                <div class="bottom">
                    <div class="head-nav">
                        <div class="head-nav-con clearFloat">
                            <ul>
                                <li class="drop-down">
                                    <a href="Union.html">网站首页</a>
                                    <ul class="drop-down-content">
                                        <li><a href="First web.html">校园新闻</a></li>
                                        <li><a href="Second web.html">通知公告</a></li>
                                    </ul>
                                </li>
                                <li class="drop-down">
                                    <a href="#">部门介绍</a>
...
<div class="main">
    <div id="left" class="left1">
        <ul class="nav nav-pills nav-stacked teach" id="lead">
            ...
            <li onclick="show1()"><a  href="First web.html" >校园新闻</a></li>
            <li onclick="show2()"><a  href="Second web.html" >通知公告</a></li>
        </ul>
    ...
    <div class="picture">
        ...
        <div class="now">
            <p>当前位置：<a href="index.jsp">网站首页</a>>><a href="Second web.html">通知公告</a></p>
        </div>
    </div>
    <div class="news" id="news">
        <ul id="idData">
            <c:forEach items="${APage}" var="list">
                <li title="${list.noticeTitle}"><a href="/">${list.noticeTitle}</a></li>
            </c:forEach>
        </ul>
        <div id="fenye">
            <tbody >
            <table align="center">
                <tr>
                    ...
                    <td>
                        <c:if test="${pagenow!=1}">
                    <td><a href="NoticeShowServlet?flag=1&a=1&pno=${pagenow}">首页</a></td>
                    <td><a href="NoticeShowServlet?flag=2&a=1&pno=${pagenow}">上一页</a></td>
                    </c:if>
                    </td>
                    <%--跳转指定页面--%>
                    <form action="NoticeShowServlet?flag=5&a=1" method="post">
                        <td>
                            转到第
                            <select name="pages">
                    ...
                    <td><a href="NoticeShowServlet?flag=3&a=1&pno=${pagenow}">下一页</a></td>
                    <td><a href="NoticeShowServlet?flag=4&a=1&pno=${pagenow}">尾页</a></td>
                    </c:if>
                    </td>
                </tr>
            </table>
