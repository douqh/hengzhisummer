...
<div class="ability">
    <div id="left" class="left1">
        <ul class="nav nav-pills nav-stacked teach" id="lead">
            ...
            <li>
                <a id="tkgl" href="NoticeShowServlet?flag=1&a=2">公告管理</a>
            </li>
            <li>
    ...
    <div class="correct">
        ...
        <div class="newscontrol" id="newscontrol">
            <div class="search">
                ...
                <input type="text" placeholder="请输入管理员序号..." id="search" onkeyup="Search()"/>
            </div>
            <div class="fabu">
            ...
            <div class="right1" id="right1">
                <table id="news">
                    ...
                    <c:forEach items="${APage}" var="list">
                        <tr id="listTable">
                            <td class="newsid">${list.studentID}</td>
                            <td class="name">${list.username }</td>
                            <td>${list.age}</td>
                            <td>${list.email}</td>
                            <td class="do">
                                <a href="DeleteUserServlet?studentID=${list.studentID}"><input type="button" name="" value="删除" class="btn btn-danger" onclick="del(this)" /></a>
                                <a href="UpdateUser.jsp?StudentID=${list.studentID}"><input type="button" name="" value="修改" class="btn btn-info" onclick="modify(this)" /></a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
